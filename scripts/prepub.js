...
if (fs.existsSync(path.join(__dirname, '../dist'))) {
  // Build a entry less file to dist/modo-mobile.less
  ...
  fs.readdir(componentsPath, function(err, files) {
    ...
    // Build less entry file: dist/modo-mobile.less
    fs.writeFileSync(
      path.join(process.cwd(), 'dist', 'modo-mobile.less'),
      '@import "../lib/style/index.less";\n@import "../lib/style/components.less";'
    );
  });
  console.log('Built a entry less file to dist/modo-mobile.less');
}
