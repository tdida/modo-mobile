...
function (_React$PureComponent) {
  ...
  _createClass(ActivityIndicator, [{
    ...
    value: function render() {
      ...
      switch (type) {
        case 'carousel':
          node = React.createElement(_carousel["default"], {
            size: size,
            color: color,
            prefixCls: prefixCls
          });
      ...
      var wrapCls = (0, _classnames2["default"])((_classnames = {}, _defineProperty(_classnames, prefixCls, true), _defineProperty(_classnames, "".concat(prefixCls, "-vertical"), vertical), _classnames));
