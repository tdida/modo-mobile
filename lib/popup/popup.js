...
var _titleBar = _interopRequireDefault(require("./title-bar"));
...
function (_React$Component) {
  ...
  _createClass(Popup, [{
    ...
    value: function render() {
      ...
      var maskNode = hasMask && React.createElement(_rcAnimate["default"], {
        component: "",
        transitionName: "fade",
        showProp: "show"
      }, visible || !destroyed ? React.createElement(_view["default"], {
        show: visible
      ...
      }, maskNode, React.createElement(_rcAnimate["default"], {
        component: "",
...
Popup.TitleBar = _titleBar["default"];
Popup.defaultProps = {
  closable: true,
  hasMask: true,
  maskClosable: true,
