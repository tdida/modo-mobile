...
function (_React$PureComponent) {
  ...
  _createClass(Agree, [{
    ...
    value: function render() {
      ...
      var wrapCls = (0, _classnames2["default"])(prefixCls, className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classnames, "".concat(prefixCls, "-checked"), value), _classnames));
