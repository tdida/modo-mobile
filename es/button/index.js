...
function (_React$PureComponent) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var wrapCls = classnames(prefixCls, className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-").concat(type), type), _defineProperty(_classnames, "".concat(prefixCls, "-").concat(shape), shape), _defineProperty(_classnames, "".concat(prefixCls, "-sm"), size === 'small'), _defineProperty(_classnames, "".concat(prefixCls, "-inline"), inline || shape), _defineProperty(_classnames, "".concat(prefixCls, "-loading"), loading), _defineProperty(_classnames, "".concat(prefixCls, "-icon"), !!iconType), _classnames));
