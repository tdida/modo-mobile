...
function (_React$PureComponent) {
  ...
  _createClass(Stepper, [{
    ...
    value: function render() {
      ...
      var wrapCls = classnames((_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls), true), _defineProperty(_classnames, "".concat(prefixCls, "-disabled"), disabled), _classnames));
      var reduceCls = classnames((_classnames2 = {}, _defineProperty(_classnames2, "".concat(prefixCls, "-button"), true), _defineProperty(_classnames2, "".concat(prefixCls, "-button-reduce"), true), _defineProperty(_classnames2, "".concat(prefixCls, "-button-disabled"), disabledReduce), _classnames2));
      var addCls = classnames((_classnames3 = {}, _defineProperty(_classnames3, "".concat(prefixCls, "-button"), true), _defineProperty(_classnames3, "".concat(prefixCls, "-button-add"), true), _defineProperty(_classnames3, "".concat(prefixCls, "-button-disabled"), disabledAdd), _classnames3));
