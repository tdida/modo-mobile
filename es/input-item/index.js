...
function (_React$Component) {
  ...
  _createClass(InputItem, [{
    ...
    value: function render() {
      ...
      var wrapCls = classnames("".concat(prefixCls), className, (_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classnames, "".concat(prefixCls, "-").concat(align), align), _defineProperty(_classnames, "".concat(prefixCls, "-focus"), focus), _defineProperty(_classnames, "".concat(prefixCls, "-has-clear"), clear), _defineProperty(_classnames, "".concat(prefixCls, "-has-error"), error), _defineProperty(_classnames, "".concat(prefixCls, "-virtual-show"), focus && type === 'money'), _classnames));
      var virtualCls = classnames("".concat(prefixCls, "-virtual-value"), _defineProperty({}, "".concat(prefixCls, "-virtual-placeholder"), !value));
      ...
      }, focus || value ? value : placeholder)), React.createElement(NumberKeyboard, {
        visible: focus,
