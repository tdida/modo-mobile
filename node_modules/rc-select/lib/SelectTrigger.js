...
function (_React$Component) {
  ...
  function SelectTrigger(props) {
    ...
    _this.saveDropdownMenuRef = (0, _util.saveRef)(_assertThisInitialized(_assertThisInitialized(_this)), 'dropdownMenuRef');
    _this.saveTriggerRef = (0, _util.saveRef)(_assertThisInitialized(_assertThisInitialized(_this)), 'triggerRef');
    _this.state = {
      dropdownWidth: 0
    };
    return _this;
