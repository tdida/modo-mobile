...
export default class Drawer extends React.Component<DrawerProps, IDrawerState> {
    static propTypes: {
        ...
        getContainer: PropTypes.Requireable<string | HTMLElement | ((...args: any[]) => any)>;
        ...
        placement: PropTypes.Requireable<import("../tabs").TabsPosition>;
    ...
    static defaultProps: {
        ...
        height: number;
        closable: boolean;
        placement: import("../tabs").TabsPosition;
        maskClosable: boolean;
        mask: boolean;
        level: null;
    };
