...
function Divider(_a) {
  ...
  var classString = (0, _classnames["default"])(className, "".concat(prefixCls, "-divider"), "".concat(prefixCls, "-divider-").concat(type), (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-divider-with-text").concat(orientationPrefix), children), _defineProperty(_classNames, "".concat(prefixCls, "-divider-dashed"), !!dashed), _classNames));
